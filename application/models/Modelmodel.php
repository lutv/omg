...
/*	Nama 	: Lutfi Muhamad Majid
	...
	var $table='tb_ma';
	var $column_order=array(null,'KDAC',null);
	var $column_search=array('KDAC','NMAC');
	var $table2='tb_subacc';
	var $column_order2=array(null,'subacc_id',null);
	var $column_search2=array('subacc_id','nama');
	var $table3='tb_inv';
	var $column_order3=array(null,'inv_id',null);
	var $column_search3=array('inv_id','inv_nama');
//	var $order=array('waktu_sort'=>'desc');
